...
{
    public partial class AddGetCompanyByName : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
        var sql = @"
        CREATE OR REPLACE FUNCTION public.getcompanybyname(""paramName"" text)
        RETURNS TABLE(
            ""CompaniesId"" int,
            ""Name"" text,
            ""TradeName"" text,
        ...
        var sql = @"
        DROP FUNCTION IF EXISTS public.getcompanybyname;
        ";
